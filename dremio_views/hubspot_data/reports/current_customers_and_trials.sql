WITH      deals_cte AS (
            SELECT d.properties_dealname AS deal_name,
                   ...
                   d.properties_hs_v2_date_entered_closedwon.member0 AS date_won,
                   d.properties_hs_v2_date_entered_37336401.member0 AS date_churned,
                   d.properties_hs_v2_date_entered_presentationscheduled.member0 AS date_entered_trial,
                   FLATTEN(d.companies) companies_aggd,
                   d.properties_hs_object_id AS deal_id
            FROM   "hubspot_data"."deals_deduped" d
            WHERE  (d.properties_hs_v2_date_entered_closedwon.member0 < CURRENT_DATE() OR
                    d.properties_hs_date_entered_presentationscheduled.member0 < CURRENT_DATE()) AND
                   (d."properties_hs_v2_date_entered_37336401".member0 IS NULL OR
                    ...
                    d."properties_hs_v2_date_entered_37336401".member0 < d.properties_hs_v2_date_entered_presentationscheduled.member0) AND
                   d."properties_hs_v2_date_entered_closedlost".member0 IS NULL AND
                   d."properties_hs_date_entered_closedlost".member0 IS NULL)
